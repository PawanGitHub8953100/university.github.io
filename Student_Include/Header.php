...
<body>
  <div class="admin_container">
    ...
    <tr>
      <th scope="col"><a href="_admin/student_details.php?st_id=<?=$_SESSION['user_id']?>">Details</a></th>
      <th scope="col"><a href="_admin/fees_view.php?st_id=<?=$_SESSION['user_id']?>">Fees Details</a></th>
      <th width="220px" scope="col"><a href="_admin/Admit_card.php?st_id=<?=$_SESSION['user_id']?>">Admit Card</a></th>
      <th scope="col"><a href="_admin/AdmitCardPdf.php?st_id=<?=$_SESSION['user_id']?>">Admit Card Pdf</a></th>
   <th scope="col"><a href="_admin/mark_result.php?st_id=<?=$_SESSION['user_id']?>">Result</a></th>
     <th>
