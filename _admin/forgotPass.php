...
<div class="forgot-main_div">
	<div class="forgot-div-box">
		...
		<div class="forgor-txt">Security Question:<select id="sec_que" name="sec_que"><?=get_option_list("security","security_id","security_question",$data)?></select></div>
		<div class="forgor-txt">Answer:<input type="text" name="sec_ans" id="sec_ans" /></div>
	
		<div class="btn"><input type="submit" id="btn-color" value="recovery" onclick="forgot_recovery();"/>
	</div>
...
<input type="hidden" name="act" id="act" value="forgot_rec"/>
</form>
<?php #}?>
