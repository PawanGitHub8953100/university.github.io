...
<form action="Admin_lib/student.php" method="post" enctype="multipart/form-data" name="form_stu" id="form_stu" onsubmit="return valid_student(this);">

<table width="1529" id="table-middel">  
  <tr>
  ...
  <tr>
    ...
    <td><a href="uploads/<?=$data[st_image]?>" rel="facebox"><img src="_admin/uploads/<?=$data[st_image]?>"  width="65px" height="60px"/></a></td>
    </tr>
  <tr>
